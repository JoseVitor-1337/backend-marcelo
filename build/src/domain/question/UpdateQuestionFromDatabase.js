...
class UpdateQuestionFromDatabase {
    findQuestionById(questionId) {
        return __awaiter(this, void 0, void 0, function* () {
            const hasQuestions = yield Question_1.default.findById(questionId).lean();
            return hasQuestions ? true : false;
        });
    }
    update(questionId, question) {
        return __awaiter(this, void 0, void 0, function* () {
            const updatedQuestion = yield Question_1.default.findByIdAndUpdate(questionId, question, {
                new: true,
                lean: true,
                runValidators: true,
            });
