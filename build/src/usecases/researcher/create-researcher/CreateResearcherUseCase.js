...
class CreateParticipantUseCase {
    ...
    create(researcher) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let participantAlreadyExist = yield this.createResearcher.findByEmailTheParticipant(email);
            let researcherAlreadyExist = yield this.createResearcher.findByEmailTheResearcher(email);
            ...
            researcher.password = yield bcryptjs_1.default.hash(researcher.password, 10);
            yield this.createResearcher.save(researcher);
        });
    }
}
