...
const AddParticipantIntoSearch = new AddParticipantIntoSearchUseCase_1.default(new search_1.SaveUserInSearchIntoDatabase(), new participants_1.GetParticipantFromDatabase());
